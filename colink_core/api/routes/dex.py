...
# DUPLICATE_DISABLED: @router.post("/offer_legacy")
...
# DUPLICATE_DISABLED: @router.get("/offers_legacy")
def get_offers():
    try:
...
# DUPLICATE_DISABLED: @router.delete("/offers_legacy/{seq}")
...
# DUPLICATE_DISABLED: @router.get("/orderbook_legacy")
