...
from sqlalchemy import Column, String, Integer, DateTime, Text, JSON, ForeignKey, Numeric, Enum, UniqueConstraint
...
class IdempotencyKey(Base):
    ...
    body_bytes: Mapped[bytes] = mapped_column(Text, nullable=False)
